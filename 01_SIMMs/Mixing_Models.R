...
setwd("/Users/janeidepadilha/Desktop/Multi-Crash/Aulas/SIA/Prática SIA/01_SIMMs")
...
Lion <- rep("Lion", length(Adacol2_SPOM))
AdaCol_SPOM <- as.data.frame(rbind(cbind(Adacol1_SPOM,Elephants),cbind(Adacol2_SPOM,Lion)))
colnames(AdaCol_SPOM)=c("Proportion","Site")
AdaCol_SPOM$Proportion <- as.numeric(paste(AdaCol_SPOM$Proportion))
